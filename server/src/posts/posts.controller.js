...
var PostsController = function () {
    ...
    var PostsController = _classThis = /** @class */ (function () {
        ...
        PostsController_1.prototype.uploadImages = function (files) {
            return __awaiter(this, void 0, void 0, function () {
                var filePaths;
                return __generator(this, function (_a) {
                    filePaths = files.map(function (file) { return (0, path_1.join)("uploads", file.filename); });
                    return [2 /*return*/, { filePaths: filePaths }];
                });
            });
        };
    ...
    (function () {
        ...
        _uploadImages_decorators = [(0, common_1.Post)("upload"), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)("images", {
